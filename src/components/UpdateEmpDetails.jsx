...
export default function UpdateEmpDetails() {
    ...
    const {updateWorkerDetails, allWorkers} = useOperation();
    const {idParam} = useParams();
    const worker = allWorkers.find((worker) => worker.id === idParam);
    ...
    const [jobrole, setJobrole] = useState(worker.jobrole||'');
    ...
    const handleUpdateWorkerDetails = (e) => {
      e.preventDefault();
      updateWorkerDetails(idParam,{firstname, lastname, email, jobrole, address, city, state, pincode});
    ...
    return (
        ...
        <form onSubmit={handleUpdateWorkerDetails}>
          <div className="space-y-12">
            ...
            <div className="border-b border-gray-900/10 pb-12 mt-6">
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">Use a permanent address where Employee can receive mail.</p>
